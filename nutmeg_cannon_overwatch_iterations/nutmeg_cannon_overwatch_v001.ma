...
//Last modified: Sat, Sep 05, 2020 05:12:02 PM
//Codeset: 936
...
createNode transform -s -n "persp";
	...
	setAttr ".t" -type "double3" -216.06725519049024 279.44964665932378 130.28445721520569 ;
	setAttr ".r" -type "double3" -8.1383527295332332 -409.79999999991514 6.1594949249760124e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "713036E4-45E6-1094-528D-E09D0321E02A";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 255.69436083317692;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -22.73574410662944 243.25255477275823 -33.093336633514824 ;
	setAttr -s 2 ".ip";
...
createNode animCurveTL -n "center_COG_anim_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 -9.4739031434680051e-15 32 -14.97525359887492
		 33 -10.135971408823769 56 -10.152839349530883 57 3.0337230749459478;
...
createNode animCurveTL -n "center_COG_anim_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 92.158011742867515 32 115.33497500125901
		 33 138.13429109822914 56 136.14642029274216 57 131.05834986608534;
	setAttr -s 5 ".kot[0:4]"  5 5 5 18 5;
createNode animCurveTL -n "center_COG_anim_translateZ";
	rename -uid "010A5294-4DC5-5E5B-72E4-11A9426ACDCB";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 -40.42067301118918 32 -37.420143243269244
		 33 -22.630186782314446 56 -23.496833730316879 57 -27.265595771673272;
	setAttr -s 5 ".kot[0:4]"  5 5 5 18 5;
...
createNode animCurveTA -n "center_COG_anim_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 23.601369679840055 32 14.824678881529538
		 33 14.799429174268681 56 14.799429174268681 57 23.538218342480757;
	setAttr -s 5 ".kot[0:4]"  5 5 5 18 5;
createNode animCurveTA -n "center_COG_anim_rotateY";
	rename -uid "C771A018-4FD2-34A4-DB8A-B484C5CE643F";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0 32 18.541810578783252 33 18.595153609768314
		 56 18.595153609768314 57 -1.7766680623225681;
	setAttr -s 5 ".kot[0:4]"  5 5 5 18 5;
createNode animCurveTA -n "center_COG_anim_rotateZ";
	rename -uid "9FB9FC84-4B16-28B0-B9BF-4EB9CD61E3AB";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0 32 -50.212795928433707 33 -50.357253381370988
		 56 -50.357253381370988 57 4.0710961159492838;
	setAttr -s 5 ".kot[0:4]"  5 5 5 18 5;
createNode animCurveTU -n "center_COG_anim_tail_twitch_offset";
	rename -uid "754B808E-447E-3C90-A2BF-3CA022305490";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0 32 0 33 0 56 0 57 0;
	setAttr -s 5 ".kot[0:4]"  5 5 5 18 5;
...
createNode animCurveTU -n "center_COG_anim_tail_twitch_length";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 5 32 5 33 5 56 5 57 5;
	setAttr -s 5 ".kot[0:4]"  5 5 5 18 5;
...
createNode animCurveTA -n "center_tail_1_FK_anim_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0 32 0 33 1.2927765178610222 57 0;
	setAttr -s 4 ".kot[0:3]"  5 5 5 5;
createNode animCurveTA -n "center_tail_1_FK_anim_rotateY";
	rename -uid "52BC6995-46B8-2789-DB4B-82A1CB3871A4";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0 32 -2.9994264896516194 33 -2.7163172560285922
...
createNode animCurveTA -n "center_tail_1_FK_anim_rotateZ";
	...
	setAttr -s 4 ".ktv[0:3]"  1 -79.138790492509102 32 71.357076082527044
		 33 46.326761827244447 57 71.790038421330181;
	setAttr -s 4 ".kot[0:3]"  5 5 5 5;
...
createNode animCurveTA -n "center_tail_5_FK_anim_rotateZ";
	...
	setAttr -s 4 ".ktv[0:3]"  1 29.04490209043831 32 29.04490209043831
		 33 1.0084125011279421 57 29.04490209043831;
	setAttr -s 4 ".kot[0:3]"  5 5 5 5;
...
createNode animCurveTA -n "center_tail_6_FK_anim_rotateZ";
	...
	setAttr -s 4 ".ktv[0:3]"  1 28.404902926351145 32 28.404902926351145
		 33 -12.8536019849079 57 28.404902926351145;
	setAttr -s 4 ".kot[0:3]"  5 5 5 5;
